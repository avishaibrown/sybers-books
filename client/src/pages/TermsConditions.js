    ...
    >
      ...
      >
        <Typography paragraph>
          This website is operated by Syber's Books. Throughout the site, the
          terms “we”, “us” and “our” refer to Syber's Books. Syber's Books
        ...
        <Typography paragraph>
          <b>ONLINE STORE TERMS:</b> By agreeing to these Terms of Service, you
          ...
          our products for any illegal or unauthorised purpose nor may you, in
        ...
        <Typography paragraph>
          <b>GENERAL CONDITIONS:</b> We reserve the right to refuse service to
          anyone for any reason at any time. You understand that your content
        ...
        <Typography paragraph>
          <b>ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION:</b> We are
        ...
        <Typography paragraph>
          <b>MODIFICATIONS TO THE SERVICE AND PRICES:</b> Prices for our
        ...
        <Typography paragraph>
          <b>PRODUCTS OR SERVICES:</b> Certain products or services may be
          ...
          exchange only in special circumstances. We have made every effort to
          display as accurately as possible the colours and images of our
          products that appear at the store. We cannot guarantee that your
          computer monitor’s display of any colour will be accurate. We reserve
        ...
        <Typography paragraph>
          <b>ACCURACY OF BILLING AND ACCOUNT INFORMATION:</b> We reserve the
        ...
        <Typography paragraph>
          <b>OPTIONAL TOOLS:</b> We may provide you with access to third-party
        ...
        <Typography paragraph>
          <b>THIRD-PARTY LINKS:</b> Certain content, products and services
        ...
        <Typography paragraph>
          <b>USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS:</b> If, at our
        ...
        <Typography paragraph>
          <b>PERSONAL INFORMATION:</b> Your submission of personal information
          through the store is governed by our{" "}
          <Link href={PRIVACY_POLICY.link}>Privacy Policy</Link>.
        </Typography>
        <Typography paragraph>
          <b>ERRORS, INACCURACIES AND OMISSIONS:</b> Occasionally there may be
        ...
        <Typography paragraph>
          <b>PROHIBITED USES:</b> In addition to other prohibitions as set forth
          in the Terms of Service, you are prohibited from using the site or its
        ...
        <Typography paragraph>
          <b>DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY:</b> We do not
          ...
          case shall Syber's Books, our directors, officers, employees,
        ...
        <Typography paragraph>
          ...
          harmless Syber's Books and our parent, subsidiaries, affiliates,
        ...
        <Typography paragraph>
          <b>SEVERABILITY:</b> In the event that any provision of these Terms of
        ...
        <Typography paragraph>
          <b>TERMINATION:</b> The obligations and liabilities of the parties
          incurred prior to the termination date shall survive the termination
          of this agreement for all purposes. These Terms of Service are
        ...
        <Typography paragraph>
          <b>ENTIRE AGREEMENT:</b> The failure of us to exercise or enforce any
        ...
        <Typography paragraph>
          <b>GOVERNING LAW:</b> These Terms of Service and any separate
          agreements whereby we provide you Services shall be governed by and
          construed in accordance with the laws of Australia.
        </Typography>
        <Typography paragraph>
          <b>CHANGES TO TERMS OF SERVICE:</b> You can review the most current
          version of the Terms of Service at any time at this page. We reserve
          the right, at our sole discretion, to update, change or replace any
        ...
        <Typography paragraph>
          <b>CONTACT INFORMATION:</b> Questions about the Terms of Service
          should be sent to us via our{" "}
          <Link href={MENU_ITEMS[3].link}>Contact page</Link>.
        </Typography>
      </Box>
    </Container>
  );
